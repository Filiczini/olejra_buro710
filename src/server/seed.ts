...
function generateSeedData(): SeedProject[] {
  const cities = ['Київ', 'Львів', 'Одеса', 'Харків', 'Дніпро', 'Вінниця', 'Запоріжжя', 'Тернопіль'];
  const years = ['2020', '2021', '2022', '2023', '2024', '2025'];
  const areas = ['80 м²', '120 м²', '150 м²', '180 м²', '220 м²', '250 м²', '280 м²', '320 м²', '350 м²'];
  ...
  const descriptions = [
    ['Цей проєкт відображає сучасні тенденції в архітектурі з акцентом на природні матеріали.', 'Великі панорамні вікна забезпечують максимальне природне освітлення протягом дня.', 'Відкритий план дозволяє вільно переміщуватися між зонами, створюючи відчуття простору.'],
    ['Лофт-стайл з високими стелями та промисловими елементами.', 'Використання цегли та бетону як основних матеріалів.', 'Великі вікна дозволяють проникати природному світлу, створюючи динамічний простір.'],
    ['Скандінавська естетика з акцентом на світлі тони та мінімалізм.', 'Функціональність кожного елемента інтер\'єру.', 'Натуральне дерево та білі стіни створюють затишну атмосферу.'],
    ['Екологічно чисті матеріали та стале дах.', 'Пасивне сонячне освітлення через встановлені панелі.', 'Автономна система водопостачання з дощовою збором.'],
    ['Кам\'яний фасад з сучасними елементами.', 'Теплий камінь в інтер\'єрі для акцентів.', 'Великі тераси для відпочинку на свіжому повітрі.'],
    ['Класична архітектура з сучасними рішеннями.', 'Високі стелі та декоративні елементи фасаду.', 'Ландшафтний дизайн з садом та альтанкою.'],
    ['Індустріальний дизайн з мінімалістичним підходом.', 'Максимальне використання простору через високі стелі.', 'Відкриті зони для спілкування та роботи.'],
  ];
