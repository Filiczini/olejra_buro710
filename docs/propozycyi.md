...
#### 2. Відсутня публічна сторінка архіву постів

**Файл:** `frontend/src/App.tsx`

В роутері немає маршруту `/posts` або `/blog`. Користувач може потрапити на статтю лише з featured-секції головної. Прямий URL до переліку статей недоступний.

**Рішення:** Створити `frontend/src/pages/PostsArchivePage.tsx` і додати роут `/posts`.
...
| ID | Завдання | Статус |
|----|----------|--------|
| 2.1 | Публічна сторінка архіву постів `/posts` | ⬜ |
