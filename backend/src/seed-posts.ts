...
const posts: SeedPost[] = [
  {
    ...
    seo_description: 'Дізнайтеся більше про архітектурне бюро Buro 710. Наша команда, філософія та підхід до дизайну.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Buro 710 — це архітектурне бюро, яке спеціалізується на створенні сучасних житлових та комерційних просторів. Ми віримо, що архітектура повинна не лише задовольняти функціональні потреби, але й надихати.',
          label: 'Хто ми',
        },
        sort_order: 0,
      },
  ...
  },
  {
    ...
    seo_description: 'Досліджуємо головні тренди в сучасній архітектурі: сталий розвиток, смарт-будинки та біофільний дизайн.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Сучасна архітектура переживає революцію. Нові технології, екологічні матеріали та зміна способу життя формують нові підходи до проектування простору.',
          label: 'Вступ',
        },
        sort_order: 0,
      },
  ...
  },
  {
    ...
    seo_description: 'Все про еко-будинки: матеріали, технології, переваги та приклади реалізованих проєктів.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Еко-будинки — це не просто тренд, а необхідність сучасності. Вони поєднують комфорт проживання з мінімальним впливом на навколишнє середовище.',
          label: 'Вступ',
          area: '150-300 м²',
          months: '6-12',
          year: '2024',
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Основні принципи еко-будівництва: використання натуральних матеріалів (дерево, камінь, глина), енергоефективність, збір дощової води, сонячні панелі.',
          label: 'Принципи',
        },
        sort_order: 2,
      },
  ...
  },
  {
    ...
    seo_description: 'Повний гід з ремонту квартири: планування, бюджет, вибір матеріалів та підрядників.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Ремонт квартири — це складний процес, який потребує ретельного планування. У цій статті ми розкажемо про основні етапи та помилки, яких варто уникнути.',
          label: 'Вступ',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Третій крок — інженерні комунікації (електрика, сантехніка, опалення). Це найважливіший етап, від якого залежить комфорт проживання.',
          label: 'Крок 3',
        },
        sort_order: 3,
      },
  ...
  },
  {
    ...
    seo_description: 'Дізнайтеся, як створити мінімалістичний інтер\'єр: основні принципи, кольорова палітра та практичні поради.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Мінімалізм — це не просто стиль, а філософія життя. В інтер\'єрі він проявляється через чисті лінії, відкритий простір та функціональність кожного елемента.',
          label: 'Філософія',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Основні принципи мінімалізму: нейтральна кольорова палітра (білий, сірий, бежевий), натуральні матеріали, відсутність зайвих деталей, приховані системи зберігання.',
          label: 'Принципи',
        },
        sort_order: 2,
      },
  ...
  },
  {
    ...
    seo_description: 'Все про скандинавський стиль: затишок, натуральні матеріали, світлі тони та функціональність.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Скандинавський стиль зародився в країнах Північної Європи і став одним з найпопулярніших у світі. Його головні риси — світлі тони, натуральне дерево та затишна атмосфера.',
          label: 'Походження',
        },
        sort_order: 0,
      },
  ...
  },
  {
    ...
    seo_description: 'Історія виникнення стилю лофт, його особливості та як створити лофт-інтер\'єр у своїй квартирі.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Лофт зародився в 1950-х роках в Нью-Йорку, коли художники почали заселяти покинуті промислові будівлі. Сьогодні це один з наймодніших стилів інтер\'єру.',
          label: 'Історія',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Характерні риси лофту: відкритий план, високі стелі, цегляні стіни, великі вікна, відкриті комунікації, поєднання старого та нового.',
          label: 'Особливості',
        },
        sort_order: 2,
      },
  ...
  },
  {
    ...
    seo_description: 'Як спланувати ідеальну кухню: робочий трикутник, зони зберігання, вибір матеріалів та техніки.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Кухня — серце дому. Правильне планування зробить приготування їжі комфортним та приємним. Розглянемо основні принципи ергономіки кухні.',
          label: 'Вступ',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Зони зберігання: продукти біля холодильника, посуд біля мийки, каструлі та сковорідки біля плити. Верхні шафки — для рідко використовуваних предметів.',
          label: 'Зберігання',
        },
        sort_order: 2,
      },
  ...
  },
  {
    ...
    seo_description: 'Головні тренді в дизайні ванних кімнат у 2025 році: натуральні матеріали, кольори та технології.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'У 2025 році ванні кімнати стають справжніми спа-зонами. Натуральні матеріали, теплі тони та розумні технології — головні тенденції року.',
          label: 'Тренди',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Популярні матеріали: натуральний камінь, дерево (з вологостійкою обробкою), латунь та матовий чорний метал. Кольорова палітра: пісочний, оливковий, теракотовий.',
          label: 'Матеріали',
        },
        sort_order: 2,
      },
  ...
  },
  {
    ...
    seo_description: 'Як створити ідеальну дитячу кімнату: зонування, безпека, кольори та меблі, що ростуть разом з дитиною.',
    ...
    blocks: [
      {
        type: 'text_full',
        data: {
          content: 'Дитяча кімната — це не просто місце для сну, а простір для гри, навчання та розвитку. Важливо створити безпечне та функціональне середовище.',
          label: 'Вступ',
        },
        sort_order: 0,
      },
      ...
      },
      {
        type: 'text_full',
        data: {
          content: 'Безпека — пріоритет дитячої кімнати. Закруглені кути, безпечні матеріали, фіксація меблів до стіни, захисти на розетках.',
          label: 'Безпека',
        },
        sort_order: 2,
      },
